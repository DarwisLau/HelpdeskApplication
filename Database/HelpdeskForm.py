...
def viewForm (dataClientRole, dataClientEmail, dataFormNumber):
    ...
    try:
        ...
        if dataClientRole == "user":
            ...
            dbCursor.execute('''
            SELECT a.administratorEmail, v.MAX(formDateTimeViewed)
             FROM Administrator a, AdministratorViewingOFForm v
              WHERE
               v.formNumber = ? AND
               v.administratorNumber = a.administratorNumber;
            ''',
            (dataFormNumber,))
...
#print(userSubmitForm("chan@mail.com", "", "issue", "C:\\Users\\User\\OneDrive\\Pictures\\Screenshots\\2021-11-07 (1).png"))
#print(listFormsSubmitted("chan@mail.com"))
#a = viewForm("user", "chan@mail.com",2)
#from PIL import Image
#import base64
#b = a[5].decode("utf-8","ignore")
#img= Image.open(b)
#img.show()
