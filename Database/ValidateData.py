...
def validate_FAQData (category, title, keyword, subCategory, content, linkPartName, linkURL):
    ...
    """Function to check whether these fields in a frequently asked question
       ...
       Output is string or no output.
       Note: FAQCategory VARCHAR(15) NOT NULL
    ...
    elif subcategory in ["Hardware", "Security", "Architecture", "Connections"]:
        return "Subcategory should be different from any category."
